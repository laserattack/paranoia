...
class Constants(Enum):
    ...
    # Конфиг должен находиться в одной папке 
    # с этим скриптом и иметь вид:
    # {
    #     "github": {
    #         "token": "your_token"
    #     }
...
class App:
    ...
    def main(cls):
        try:
            ...
            ColorPrinter.red(f"load config error: {e}")
            sys.exit()
    ...
    def load(cls) -> 'AppConfig':
        try:
            with open(Constants.CONFIG_PATH.value, 'r') as f:        
                ...
                app_config = AppConfig(github_config)
